...
if ( has_nav_menu( 'primary' ) ) : // Check if there's a menu assigned to the 'primary' location.
	...
	?>
	<div class="screen-reader-text"><?php _e( 'Primary Navigation Menu', 'juxter' ); ?></div>
	<nav <?php hybridextend_attr( 'menu', 'primary' ); ?>>
		<a class="menu-toggle" href="#"><span class="menu-toggle-text"><?php _e( 'Menu', 'juxter' ); ?></span><i class="fas fa-bars"></i></a>
