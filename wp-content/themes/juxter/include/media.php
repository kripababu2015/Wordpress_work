...
function hoot_theme_custom_image_sizes( $sizes ) {
	$sizes = array(
		...
		// 	'label'          => __( 'Small Thumbnail', 'juxter' ),
		// 	'width'          => 315,
		// 	'height'         => 215,
		// 	'crop'           => true,
		...
		'hoot-medium-thumb' => array(
			'label'          => __( 'Medium Thumbnail', 'juxter' ),
			'width'          => 420, // 240 x 165
			'height'         => 320, // 240 x 165
			'crop'           => true,
			'show_in_editor' => false,
		),
		...
		'hoot-large-thumb' => array(
			'label'          => __( 'Large Thumbnail', 'juxter' ),
			'width'          => 550,
			'height'         => 250,
			'crop'           => true,
			'show_in_editor' => false,
