		...
		$manager->add_section(
			new Hoot_Premium_Customize_Section_Pro(
				...
				apply_filters( 'hoot_theme_customize_section_pro', array(
					'title'    => esc_html__( 'Juxter Premium', 'juxter' ),
					'priority' => 1,
					'pro_text' => esc_html__( 'Premium', 'juxter' ),
					'pro_url'  => esc_url( admin_url('themes.php?page=juxter-welcome') ),
					'demo'     => 'https://demo.wphoot.com/juxter/',
					'docs'     => 'https://wphoot.com/support/',
					'rating'   => 'https://wordpress.org/support/theme/juxter/reviews/#new-post',
				) )
			)
		);
	}
